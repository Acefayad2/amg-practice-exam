(() => {
  ...
  function updateProgress() {
    ...
    $('result').textContent = count === total ? `Practice result: ${score} of ${total} correct.` + (score === total ? ' You applied all eight distinctions correctly.' : ' Review the explanations for your missed questions.') : `${count} of ${total} answered · ${score} correct so far.`;
