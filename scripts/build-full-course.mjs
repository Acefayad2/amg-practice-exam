...
const available=[...foundationMedia.map((m,i)=>({...curriculum[i],version:2,duration:Number(m.duration_seconds),questions:8,status:'ready'})),...published].sort((a,b)=>a.number-b.number);
