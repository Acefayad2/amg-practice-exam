async page => {
 ...
 check(await page.locator('#study-guide-heading').textContent()==='Plan your study time.','Published study-time guide');
 check((await page.locator('.study-guide').textContent()).includes('4 hours 34 minutes'),'Final measured video runtime displayed');
 check(await page.locator('.study-estimates>div').count()===3,'All three study planning paths shown');
 await page.setViewportSize({width:390,height:844});
 check(await page.evaluate(()=>document.documentElement.scrollWidth<=innerWidth+1),'Course and study guide fit mobile');
